...
{
  postAsyncMessage(CommandIDs::ConsoleClearConsole, juce::String::empty, true);
}

void Console::printPrompt(bool t)
{
  if (prompt.isNotEmpty())
    postAsyncMessage(CommandIDs::ConsolePrintPrompt, juce::String::empty, t);
}
...
ConsoleWindow::ConsoleWindow ()
  : juce::DocumentWindow (juce::String::empty , juce::Colour (227,227,227), //juce::Colours::silver,
                          juce::DocumentWindow::allButtons, true )
{
  ...
  cons->buffer = new juce::TextEditor(juce::String::empty) ;
  // MACMENU
