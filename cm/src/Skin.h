...
public:
  ...
  Skin()
  {
    ...
    if(SysInfo::isMac())
      ...
      fontMenuBar->setTypefaceName("Genava");
    ...
    setColour(juce::TextEditor::highlightColourId, juce::Colours::darkgrey.withAlpha(0.5f));
    setColour(juce::CodeEditorComponent::highlightColourId, juce::Colours::darkgrey.withAlpha(0.5f));
    setColour(juce::TextEditor::focusedOutlineColourId, juce::Colours::darkgrey.withAlpha(0.5f));
