...
public: 
  ...
  static const int CM_VERSION = 390;
...
struct WindowTypes
{
  ...
  {
    if (w)
      return (w->getProperties()[juce::var::identifier("WindowType")] == juce::var(typ));
    else 
      return false;
  }
  ...
  {
    w->getProperties().set(juce::var::identifier("WindowType"), juce::var(typ));
  }
...
#define COMID(a) ((a) << 16)
  ...
  static const juce::CommandID OscTraceOutput  = COMID(Osc + 3);
