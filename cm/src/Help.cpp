...
Help::Help()
  : documentationDirectory (juce::File::nonexistent),
    documentationTable(0)
{
  // Create Help Table
...
void Help::openHelpInEditor(juce::String path, juce::String code)
{
  ...
  new CodeEditorWindow(juce::File::nonexistent, code, ttyp, path);
}
...
void Help::symbolHelp(juce::String symbol, juce::String helppath)
{
  ...
  juce::String s, h, r, x;
  while (helppath != juce::String::empty)
  {
    x = juce::String::empty;
