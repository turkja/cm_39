    ...
    fieldymenu (0)
{
  ...
  addAndMakeVisible (bggroup = new juce::GroupComponent(juce::String::empty, "Background"));
  ...
  addAndMakeVisible(fieldgroup=new juce::GroupComponent(juce::String::empty,"Point Fields"));

  addAndMakeVisible(fieldxlabel = new EditorLabel("X Axis:"));
  addAndMakeVisible (fieldxmenu = new juce::ComboBox (juce::String::empty));
  ...
  addAndMakeVisible (fieldymenu = new juce::ComboBox (juce::String::empty));
    ...
    tuningmenu(0)
{
  ...
  addAndMakeVisible (tuningmenu = new juce::ComboBox (juce::String::empty));
    ...
    fitcheckbox (0)
{
  ...
  addAndMakeVisible (typemenu = new juce::ComboBox (juce::String::empty));
  ...
  //  addAndMakeVisible (decimalsmenu = new juce::ComboBox (juce::String::empty));
  //  decimalsmenu->setEditableText (false);
  //  decimalsmenu->setJustificationType (juce::Justification::centredLeft);
  //  decimalsmenu->setTextWhenNothingSelected (juce::String::empty);
  ...
  addAndMakeVisible(zoomslider = new juce::Slider (juce::String::empty));
    ...
    colorpicker (0)
{
  ...
  addAndMakeVisible(stylemenu = new juce::ComboBox (juce::String::empty));
  ...
  addAndMakeVisible (audiogroup = new juce::GroupComponent(juce::String::empty, "Audio Defaults"));
    ...
    exportbutton (0)
{
  ...
  addAndMakeVisible (formatmenu = new juce::ComboBox (juce::String::empty));
  ...
  addAndMakeVisible(destmenu = new juce::ComboBox(juce::String::empty));
...
void PlotExportEditor::exportPoints() 
{
  ...
  {
    new CodeEditorWindow(juce::File::nonexistent, text, exportid);
  }
